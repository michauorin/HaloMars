...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
        ...
        public void RecreateFontDeviceTexture()
        {
            ...
            // ImGui doesn't support Latin2 glyph set.
            // ImGui.NET doesn't support defining glyph ranges to import fonts.
            // Eat the full UTF table if you don't want to provide a specific set for european languages.
            System.Runtime.InteropServices.GCHandle rangehandle = System.Runtime.InteropServices.GCHandle.Alloc(
                new ushort[]
                {
                    0x20,
                    0xFFFF,
            ...
            io.Fonts.AddFontFromFileTTF(@"C:\Windows\Fonts\Arial.ttf", 13, null, rangehandle.AddrOfPinnedObject());
